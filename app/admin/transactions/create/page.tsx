...
export default function CreateTransactionPage() {
    ...
    // Filter daftar mobil berdasarkan ketikan (merk, tahun, atau nopol)
                ...
                <div className="flex flex-col gap-6 w-full">
                    <div className="bg-white p-4 md:p-6 rounded-xl border border-[#E5E7EB] shadow-sm w-full">
                        ...
                        <div className="flex flex-col gap-4 md:gap-6">
                            ...
                            {/* SEARCHABLE CAR DROPDOWN - Diperbarui */}
                            <div className="relative" ref={carDropdownRef}>
                                ...
                                {/* Input Custom yang bisa diketik */}
                                <input
                                    type="text"
                                    value={carSearch}
                                    onChange={(e) => {
                                        ...
                                        // Reset nilai state sesungguhnya jika user mengetik ulang
                                ...
                                {/* Input tersembunyi agar validasi bawaan "required" html5 tetap jalan ketika tombol Simpan ditekan */}
