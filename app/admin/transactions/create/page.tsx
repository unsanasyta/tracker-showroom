                    ...
                    <div className="lg:col-span-8">
                        <div className="bg-white p-6 rounded-xl border border-[#E5E7EB] shadow-sm h-full">
                            ...
                            <div className="grid grid-cols-2 gap-5">
                                ...
                                <div><label className="block text-xs font-bold text-gray-600 mb-1.5">Tahun</label>
                                    <select name="car_year" value={purchaseForm.car_year} onChange={handlePurchaseChange} className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm outline-none focus:border-[#415A77] bg-gray-50/50 text-gray-600">
                                        <option value="">Pilih tahun...</option><option value="2024">2024</option><option value="2023">2023</option><option value="2022">2022</option><option value="2021">2021</option><option value="2020">2020</option>
                                    </select>
                                </div>
                    ...
                    <div className="lg:col-span-8">
                        <div className="bg-white p-6 rounded-xl border border-[#E5E7EB] shadow-sm h-full">
                            ...
                            <div className="flex flex-col gap-4">
                                <div><label className="block text-xs font-bold text-gray-600 mb-1.5">Cat</label><div className="flex items-center border border-gray-300 rounded-lg overflow-hidden bg-gray-50/50 focus-within:border-[#415A77]"><span className="px-3 text-sm font-bold text-gray-500 border-r border-gray-200">Rp</span><input type="number" name="paint_cost" value={purchaseForm.paint_cost} onChange={handlePurchaseChange} placeholder="0" className="w-full px-3 py-2.5 text-sm outline-none bg-transparent" /></div></div>
                                <div><label className="block text-xs font-bold text-gray-600 mb-1.5">Mesin</label><div className="flex items-center border border-gray-300 rounded-lg overflow-hidden bg-gray-50/50 focus-within:border-[#415A77]"><span className="px-3 text-sm font-bold text-gray-500 border-r border-gray-200">Rp</span><input type="number" name="engine_cost" value={purchaseForm.engine_cost} onChange={handlePurchaseChange} placeholder="0" className="w-full px-3 py-2.5 text-sm outline-none bg-transparent" /></div></div>
                                <div><label className="block text-xs font-bold text-gray-600 mb-1.5">Onderdil</label><div className="flex items-center border border-gray-300 rounded-lg overflow-hidden bg-gray-50/50 focus-within:border-[#415A77]"><span className="px-3 text-sm font-bold text-gray-500 border-r border-gray-200">Rp</span><input type="number" name="parts_cost" value={purchaseForm.parts_cost} onChange={handlePurchaseChange} placeholder="0" className="w-full px-3 py-2.5 text-sm outline-none bg-transparent" /></div></div>
                                <div><label className="block text-xs font-bold text-gray-600 mb-1.5">Pajak</label><div className="flex items-center border border-gray-300 rounded-lg overflow-hidden bg-gray-50/50 focus-within:border-[#415A77]"><span className="px-3 text-sm font-bold text-gray-500 border-r border-gray-200">Rp</span><input type="number" name="tax_cost" value={purchaseForm.tax_cost} onChange={handlePurchaseChange} placeholder="0" className="w-full px-3 py-2.5 text-sm outline-none bg-transparent" /></div></div>
                    ...
                    <div className="lg:col-span-4">
                        <div className="bg-white p-6 rounded-xl border border-[#E5E7EB] shadow-sm flex flex-col h-full">
                            ...
                            <div className="flex flex-col flex-1">
                                ...
                                <div className="flex-1 border-2 border-dashed border-gray-300 bg-[#F8FAFC] rounded-xl p-6 flex flex-col items-center justify-center text-center hover:bg-gray-50 transition-colors cursor-pointer min-h-[150px]">
                                    <div className="w-12 h-12 bg-[#D6E4F8] rounded-full flex items-center justify-center text-[#415A77] mb-3"><UploadCloud size={24} /></div>
                                    <h4 className="text-sm font-bold text-[#1B263B]">Tarik dan lepas file di sini</h4><p className="text-xs text-gray-500 mt-1">atau klik (PDF, JPG, PNG)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="grid grid-cols-2 gap-5 pt-2">
                                <div>
                                    ...
                                    <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden bg-gray-50/50 focus-within:border-[#415A77]"><span className="px-3 text-sm font-bold text-gray-500 border-r border-gray-200">Rp</span><input type="number" name="sell_price" value={saleForm.sell_price} onChange={handleSaleChange} placeholder="0" className="w-full px-3 py-2.5 text-sm outline-none bg-transparent" /></div>
                                </div>
                                <div>
