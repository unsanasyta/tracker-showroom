        ...
        <div className="flex flex-col gap-6 pb-10">
            ...
            <div className="bg-white p-4 md:p-6 rounded-xl border border-[#E5E7EB] shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4 md:gap-6">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                    <Link href="/admin/transactions" className="w-full sm:w-auto text-center px-6 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-lg text-sm font-bold hover:bg-gray-50 transition-colors shadow-sm">
                        Batal
                    </Link>
                    <button
                        onClick={handleUpdateTransaction}
                        disabled={isLoading}
                        className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-2.5 bg-[#1B263B] text-white rounded-lg text-sm font-bold hover:bg-[#0F172A] transition-colors shadow-sm disabled:opacity-50"
                    >
                        ...
                        <div className="bg-white p-4 md:p-6 rounded-xl border border-[#E5E7EB] shadow-sm flex flex-col h-full">
                            ...
                            <div className="flex flex-col mb-4">
                                ...
                                <label htmlFor="edit-file-upload" className="border-2 border-dashed border-gray-300 bg-[#F8FAFC] rounded-xl p-4 flex flex-col items-center justify-center text-center hover:bg-gray-50 hover:border-[#415A77] transition-colors cursor-pointer">
                                    ...
                                    <h4 className="text-xs md:text-sm font-bold text-[#1B263B]">Tambah File</h4>
                                </label>
                            </div>
                            ...
                            <div className="flex flex-col gap-3 flex-1 overflow-y-auto pr-1">
                                {existingFiles.length > 0 && (
                                    <div>
                                        <p className="text-[10px] md:text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-2">File Tersimpan ({existingFiles.length})</p>
                                ...
                                {newFiles.length > 0 && (
                                    <div className={existingFiles.length > 0 ? "pt-3 border-t border-gray-100" : ""}>
                                        <p className="text-[10px] md:text-[11px] font-bold text-green-600 uppercase tracking-wider mb-2">File Baru ({newFiles.length})</p>
                                        <div className="flex flex-col gap-2">
